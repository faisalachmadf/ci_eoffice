<div class="left_col scroll-view">
  ...
  <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
      ...
      <ul class="nav side-menu">
        <li title="Dashboard"><a href="<?= base_url() ?>admin/menu/Dashboard"><i class="fa fa-home"></i> Dashboard</a></li>
    ...
    <div class="menu_section">
      ...
      <ul class="nav side-menu">
        <li><a href="<?= base_url() ?>admin/pengaturan/Profile"><i class="fa fa-user"></i> Data Profile</a></li>
         ...
         <li><a> <i class="fa fa-group"></i>Data User</a></li>
      </ul>
    </div>
  </div>
  <!-- /sidebar menu -->
  ...
  <div class="sidebar-footer hidden-small">
    ...
    <a data-toggle="tooltip" data-placement="top" class="tombol_logout" href="<?= base_url() ?>/Login/Auth" title="logout">
